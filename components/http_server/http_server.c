...
extern const unsigned char jquery_3_3_1_min_js_start[]		asm("_binary_jquery_3_3_1_min_js_start");
extern const unsigned char jquery_3_3_1_min_js_end[]		asm("_binary_jquery_3_3_1_min_js_end");
